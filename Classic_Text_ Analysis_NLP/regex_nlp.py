...
single_pos_sentence = pos_tagged_text[8]
...
vp_chunk_grammar2 = 'VP: {<VB.*><DT>?<JJ>*<NN><RB.?>?}'

# create verb phrase RegexpParser object here
vp_chunk_parser = RegexpParser(vp_chunk_grammar)
vp_chunk_parser2 = RegexpParser(vp_chunk_grammar2)
...
for sentence in pos_tagged_text:
  ...
  vp_chunked_text2.append(vp_chunk_parser2.parse(sentence))
...
print('\nMost Common Verb Phrases (NP First)')
print(most_common_vp_chunks)

most_common_vp_chunks2 = vp_chunk_counter(vp_chunked_text2)
print('\nMost Common Verb Phrases (Verb First)')
